...
#distance between the wheels along y axis
d=0.94

#wheel distance in meters from the x axis and y axis
wheel_positions=[ 
    [0.51,0.4],    #front left
...
def callback(data,pub,rate,params):
    in_place_delay=4 #How much to wait for wheel to be in position before starting inplace movement
